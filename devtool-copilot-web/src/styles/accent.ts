...
export const ACCENT_PALETTE: AccentPaletteItem[] = [
  { key: 'slate', label: 'Slate', accent: '#111827', accent2: '#334155', dotRgb: '17, 24, 39' },
...
function hexToRgb(hex: string): string {
  ...
  if (!Number.isFinite(r) || !Number.isFinite(g) || !Number.isFinite(b)) return '15, 23, 42'
  return `${r}, ${g}, ${b}`
}
...
export function applyAccent(key: AccentKey | string | null | undefined) {
  ...
  el.style.setProperty('--accent2-rgb', hexToRgb(p.accent2))
  return p
}
